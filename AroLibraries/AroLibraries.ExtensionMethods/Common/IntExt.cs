...
namespace AroLibraries.ExtensionMethods
{
    public static class IntExt
    {
        ...
        public static int InRange(this int iInt, int min, int max)
        {
            if (iInt > max)
            {
                return max;
        ...
        #region Numbers
        public static int GetThousand(this int iint)
        {
            return 1000;
        }

        public static int GetMillion(this int iint)
        {
            return 1000000;
        }

        public static int GetBillion(this int iint)
        {
            return 1000000000;
        }
